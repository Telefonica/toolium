...
class BaseLoginOneFilePageObject(MobilePageObject):
...
class AndroidLoginOneFilePageObject(BaseLoginOneFilePageObject):
...
class IosLoginOneFilePageObject(BaseLoginOneFilePageObject):
